...
// This page fetches posts from an API and displays them in a grid layout.
// Each post shows the title and body, and the author is loaded separately using Suspense.
type Post = {
    userId: number;
    id: number;
    title: string;
